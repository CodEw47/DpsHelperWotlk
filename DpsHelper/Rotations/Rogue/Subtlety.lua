...
-- Rotation logic for Rogue Subtlety in WoW 3.3.5, optimized for stealth and burst.
...
function DpsHelper.Rotations.ROGUE.Subtlety:GetRotationQueue()
    ...
    DpsHelper.Utils:DebugPrint(2,
        "Subtlety: Checking rotation for target=" .. (target and "valid" or "invalid") .. ", AoE=" ..
    ...
    elseif target then
        ...
        local spells = {{
            ...
            condition = function()
                ...
                return DpsHelper.Utils:GetDebuffRemainingTime("target", "Hemorrhage") <= 2 and
                           DpsHelper.SpellManager:IsSpellUsable("Hemorrhage")
            ...
            condition = function()
                ...
                return comboPoints < 5 and DpsHelper.SpellManager:IsSpellUsable("Backstab")
